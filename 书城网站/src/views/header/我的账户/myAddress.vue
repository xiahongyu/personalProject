	...
	<div class="myaddress">
		<div class="addHead">
			<div class="addManager">
				<h3>收货地址管理</h3>
				<span><router-link to="/nowShopping">立即购买</router-link></span>
				<span><router-link to="/shoppingCar">前往购物车</router-link></span>
	...
	export default{
		...
		methods:{
			...
			determine(){//确定按钮
				...
				this.dialogFormVisible = false;
				this.addressArr.push(this.form);
				this.form={
					name: '',
					cellphone:'',
					region: '',
		...
		created() {
			this.addressArr = this.$store.state.addressList;
		}
	}
</script>
