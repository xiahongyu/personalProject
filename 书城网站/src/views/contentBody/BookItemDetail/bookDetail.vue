	...
	<div class="bookDetail">
		...
		<div class="detailContent">
			<div class="detailDiv">
				...
				<div class="showBody">
					<div class="showLeft">
						<div class="leftTop"><img :src="bookDetails.imgurl" alt="" /></div>
					...
					<div class="showRight">
						...
						<div class="rightBottom">
							...
							<el-button type="warning" @click="soucang">收<i class="el-icon-sell el-icon--center"></i>藏</el-button>
							<router-link to="/shoppingCar"><el-button type="danger">购物车<i class="el-icon-s-goods"></i></el-button></router-link>
						</div>
					</div>
				</div>
			</div>
