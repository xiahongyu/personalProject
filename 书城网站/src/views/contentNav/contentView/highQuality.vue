		...
		<div class="baokuanContent">
			<div class="baokuanHeader">
				...
				<div class="content">
					<header>
						<span>价格</span>
						<span class="inputVal"><el-input v-model="price1" clearable></el-input></span>
						<span>——</span>
						<span class="inputVal"><el-input v-model="price2" clearable></el-input></span>
					</header>
					<section>
			...
			<div class="baokuanBody" v-if="!shaixuan">
				<div class="pageContent">
					<div class="contentDiv">
						<router-link :to="'/BookItem/bookDetail/'+item.id" v-for="(item,index) in nowTableData" :key="index">
			...
			<div class="baokuanBody" v-else>
				<div class="pageContent">
					<div class="contentDiv">
						<router-link :to="'/BookItem/bookDetail/'+item.id" v-for="(item,index) in priceList" :key="index">
							<div class="contentItem">
								<div class="imgs"><img :src="item.imgurl" alt=""></div>
								<p class="titles">{{item.title | slices}}</p>
								<p class="author">{{item.author}}</p>
